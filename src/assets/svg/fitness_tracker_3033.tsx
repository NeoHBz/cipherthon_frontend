export const FitnessSVG = () => {
    return (
        ...
        >
            ...
            <ellipse cx="525" cy="717.87" rx="525" ry="33" fill="#6c63ff" opacity="0.1" />
            <path
                d="M1042.65,768a37,37,0,0,1-.8,7.76c-.1.48-.21,1-.32,1.41-2.84,11.39-10.85,19.72-20.41,20.25-.32,0-.64,0-1,0-10.11,0-18.66-8.72-21.48-20.73-.08-.32-.15-.64-.22-1a37,37,0,0,1-.8-7.76c0-16.27,10.07-29.45,22.5-29.45S1042.65,751.75,1042.65,768Z"
                transform="translate(-75 -74.57)"
                fill="#3f3d56"
            />
            <path
                d="M1042.65,768a37,37,0,0,1-.8,7.76c-.1.48-.21,1-.32,1.41-.34,0-.67,0-1,0a45.76,45.76,0,0,1-7.36-1,44.92,44.92,0,0,1-6.56,1.5,45.87,45.87,0,0,1-5.14.48l-1.74,0a46.41,46.41,0,0,1-6.16-.41,45.17,45.17,0,0,1-9.67-2.4,45.56,45.56,0,0,1-5.22,1.4c-.08-.32-.15-.64-.22-1a37,37,0,0,1-.8-7.76c0-16.27,10.07-29.45,22.5-29.45S1042.65,751.75,1042.65,768Z"
                transform="translate(-75 -74.57)"
                opacity="0.1"
            />
            <path
            ...
            />
            <path
                d="M1089.86,721.64a121.66,121.66,0,0,0-42.34-.54c-15.89,2.63-32.13,8.41-47.67,4.18-9.12-2.48-17-8.22-25.91-11.4a49.09,49.09,0,0,0-26.75-1.61,45.76,45.76,0,0,0,56.69,61.07,46,46,0,0,0,29.28.8,45.74,45.74,0,0,0,55.62-44.65c0-1,0-2-.1-3A45.19,45.19,0,0,0,1089.86,721.64Z"
                transform="translate(-75 -74.57)"
                opacity="0.1"
            />
            <rect
            ...
            <path
                d="M209.06,758.29,228.2,747a46,46,0,0,0-9.79-11.71L182.3,746.56l28.3-16.64a46,46,0,0,0-68.1,40.35c0,25.41,20.59,26.29,46,26.29s46-.88,46-26.29a45.75,45.75,0,0,0-3.95-18.66Z"
                transform="translate(-75 -74.57)"
                fill="#6c63ff"
            />
            <path
                d="M213.93,783a35.81,35.81,0,0,0-6.78-5.33c-3.48-2.31-7.07-4.66-11.17-5.45-3.6-.69-7.31-.11-11-.31a25.67,25.67,0,0,1-16.81-7.71c-2.61-2.7-4.67-6-7.81-8.09-3.39-2.22-7.69-2.7-11.71-2.15a33.67,33.67,0,0,0-3.46.71,45.9,45.9,0,0,0-2.72,15.61c0,25.41,20.59,26.29,46,26.29,12.33,0,23.52-.21,31.78-3.33l-1.38-2.58A36.08,36.08,0,0,0,213.93,783Z"
                transform="translate(-75 -74.57)"
                opacity="0.1"
            />
            <path
                d="M303.24,656.87a11.93,11.93,0,0,0-3.28,4.72c-1.71,5.34,3.07,10.58,3.53,16.17.36,4.44-2,8.58-3.34,12.84A27.71,27.71,0,0,0,309.67,720a7.93,7.93,0,0,0,3.18,1.64,7.16,7.16,0,0,0,5.43-1.6,14.56,14.56,0,0,0,5.09-6.72,29.16,29.16,0,0,0,1.33-8.17l.71-10.7c.74-11.17,1.41-22.69-1.31-33.66-.89-3.6-2.54-11.87-6.7-12.37S306,654.17,303.24,656.87Z"
                transform="translate(-75 -74.57)"
                fill="#3f3d56"
            />
            <path
                d="M373,610.91a351.14,351.14,0,0,0-10.83,53.55c-.32,2.55-.65,5.23-2.19,7.29-3.07,4.13-9.22,3.87-14.32,3.2a8.08,8.08,0,0,1-3.49-1c-1.92-1.3-2.34-3.9-2.57-6.21q-5.24-51.08-7-102.43c-.05-1.31,42.69-1.43,46.35,2s.82,16.26,0,20.63C377.61,595.72,375.19,603.3,373,610.91Z"
                transform="translate(-75 -74.57)"
                fill="#fbbebe"
            />
            <path
            ...
            />
            <path
                d="M330.61,511.08c-13.45-2.8-26.67-7.43-40.4-7.75a3.57,3.57,0,0,0-2,.38,3.61,3.61,0,0,0-1.26,2.19q-2.13,7.35-3.81,14.81c-3.72,16.53-5.55,34.79,2.63,49.63-.08-4.82,2.95-9.33,7-12s8.9-3.75,13.7-4.19,9.93-.26,14.4,1.71a19.55,19.55,0,0,1,11.37,15.9l47.25,1.53a1.73,1.73,0,0,0,2.2-1.89,192.76,192.76,0,0,0-.19-45.61c-.52-4.23-.59-10.1-5.35-11.69-5.68-1.9-14.66.32-20.73.06A153.52,153.52,0,0,1,330.61,511.08Z"
                transform="translate(-75 -74.57)"
                fill="#3f3d56"
            />
            <path
            ...
            />
            <path
                d="M389.68,410c1.58,6.95,2.39,14.07,4.37,20.91.77,2.69,1.73,5.32,2.39,8a76.7,76.7,0,0,1,1.51,9.66l2.81,24.86a8.24,8.24,0,0,1-.35,4.6,7.52,7.52,0,0,1-3.24,2.94,37,37,0,0,1-26.66,3.75,53.45,53.45,0,0,0-6.34-1.48c-3.42-.43-6.9.26-10.35,0-7-.53-13.15-4.89-18-9.95-2.92-3-5.57-7.92-2.85-11.14a6.45,6.45,0,0,1,5.95-1.8,23.7,23.7,0,0,1,6.07,2.27,67.08,67.08,0,0,0,21.19,5.83c5,.53,11.36-.32,13.09-5.08.84-2.31.25-4.87-.34-7.26l-4.84-19.65C373.89,435.78,388.1,403.06,389.68,410Z"
                transform="translate(-75 -74.57)"
                fill="#fbbebe"
            />
            <path
            ...
            />
            <path
                d="M337.07,314.7a13.55,13.55,0,0,0-1.8-.87,13.54,13.54,0,0,1-4.9,22.9c-7.8,2.56-16.23-2.24-24.38-1.24a8.41,8.41,0,0,0-4.52,1.73c-3.63,3.14-1.82,8.93-.53,13.56.84,3,1.86,13.93-3.46,14.23h-.09c1.65,1.61,3.14,2.66,4.2,2.6,5.32-.3,4.3-11.22,3.46-14.23-1.29-4.63-3.1-10.42.53-13.56a8.41,8.41,0,0,1,4.52-1.73c8.15-1,16.58,3.8,24.38,1.24a13.56,13.56,0,0,0,2.59-24.62Z"
                transform="translate(-75 -74.57)"
                opacity="0.1"
            />
